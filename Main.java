...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (member.getRole()) {
            ...
            case ADMIN:
                adminMenu(connection, statement, sc, library, member);
                break;

            case LIBRARIAN:
                librarianMenu(connection, statement, sc, library, member);
                break;

            case STUDENT:
                studentMenu(connection, statement, sc, library, member);
                break;
